...
for i in range(number):
    ...
    if amount_of_wallet > 0 and st.session_state[customise_pressed]:
        st.image('https://pngimg.com/uploads/wallet/wallet_PNG77078.png', caption =None, width = 100, "https://toppng.com/uploads/preview/leather-wallet-11530960452p1ggvjjey4.png", caption="medium", width = 100) 
